...
model.fit_model(X_train, y_train, X_test, y_test, epochs=25, batch_size = 16, class_weights=weights)

model.save_model('./model_files/hybrid_attention_classification_model.h5')